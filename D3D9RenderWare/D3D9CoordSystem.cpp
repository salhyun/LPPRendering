...
CD3D9CoordSystem::CD3D9CoordSystem()
{
	m_pd3dDevice = NULL ;
}
CD3D9CoordSystem::~CD3D9CoordSystem()
...
void CD3D9CoordSystem::initialize(LPDIRECT3DDEVICE9 pd3dDevice)
{
	m_pd3dDevice = pd3dDevice ;
}
void CD3D9CoordSystem::setMatrix(D3DXMATRIX *pmat)
{
	m_d3dmatPivot = (*pmat) ;
}
void CD3D9CoordSystem::render()
{
	//AxisX color is RED
	...
	for(int i=0 ; i<33 ; i++)
	{
		D3DXVec3Transform(&vpos, &vertex[i].pos, &m_d3dmatPivot) ;
