#include "D3D9LPPOpaqueMesh.h"
#include "D3D9Material.h"
#include "D3D9TextureContainer.h"

D3DVERTEXELEMENT9 decl_LPPOpaque[] =
{
...
CD3D9LPPOpaqueMesh::CD3D9LPPOpaqueMesh()
{
	m_pcD3D9Material = NULL ;
	m_pcShader = NULL ;
	m_pVB = NULL ;
	m_pIB = NULL ;
	m_pDecl = NULL ;
...
void CD3D9LPPOpaqueMesh::release()
{
...
HRESULT CD3D9LPPOpaqueMesh::initialize(LPDIRECT3DDEVICE9 pd3dDevice, SMesh *psMesh)
{
	HRESULT hr ;
	...
	hr = m_pd3dDevice->CreateVertexDeclaration(decl_LPPOpaque, &m_pDecl) ;
...
void CD3D9LPPOpaqueMesh::render()
{
...
void CD3D9LPPOpaqueMesh::setMaterial(CD3D9Material *pcMaterial, CD3D9TextureContainer *pcTexContainer)
{
	...
	m_pcD3D9Material = pcMaterial ;
}
CD3D9Material *CD3D9LPPOpaqueMesh::getD3D9Material()
{
	return m_pcD3D9Material ;
}
